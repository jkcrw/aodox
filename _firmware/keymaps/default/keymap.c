...
// TODO: Rebind righthand Sp/Bp to use as leader keys
...
[QWTY] = LAYOUT(
    ...
    SC_LSPO,              KC_Z,           KC_X,          KC_C,      KC_V,   KC_B,    LCAG_T(KC_ESC), KC_PGUP,
    ...
    KC_PGDN,       LCAG_T(KC_K), KC_N,    KC_M,    KC_COMM,         KC_DOT,       KC_SLSH,      SC_RSPC,
